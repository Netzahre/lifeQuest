...
class SQLiteAyudante(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE TABLE logros (id INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, tarea_asociada TEXT NOT NULL, repeticiones_necesarias INTEGER DEFAULT 0, progreso INTEGER DEFAULT 0, completado INTEGER DEFAULT 0, usuario TEXT)")
    }
